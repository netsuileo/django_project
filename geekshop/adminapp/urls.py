...
urlpatterns = [
    ...
    path(
        "users/update/<int:pk>", adminapp.UserUpdateView.as_view(), name="update_user"
    ),
    ...
    path(
        "categories/update/<int:pk>", adminapp.update_category, name="update_category"
    ),
    path(
        "categories/delete/<int:pk>", adminapp.delete_category, name="delete_category"
    ),
